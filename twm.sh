...
messages_info () {
  printf " ##### Titan #####\n" > $TMP/msg_file
    ...
    grep -o "${URL}/images/icon/2hit[.]png" source.html | grep -A 1 "${URL}/images/icon/2hit[.]png" source.html | tail -n 1
    echo $(grep -A 1 "${URL}/images/icon/2hit[.]png" source.html | tail -n 1)
